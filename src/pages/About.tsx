...
const knowledgePanels = [
  {
    ...
    description: 'Founded in 2000, PowerLand House emerged from a vision to revolutionize the electrical equipment industry. Starting as a small workshop with just five engineers, we have grown into a powerhouse serving industries across 50+ cities.',
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="font-display text-4xl md:text-6xl font-bold text-primary-foreground mb-6">
              Powering Progress <span className="text-accent">Since 2000</span>
            </h1>
